...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions options2 =
                new MarkerOptions().position(new LatLng(37.540156, 126.839039))
                        .title("신월초등학교");
        list.add(options2);
        ...
        // 37.541765, 126.840415
        mMap.moveCamera(CameraUpdateFactory
                .newLatLngZoom(new LatLng(37.541765, 126.840415), 18));



//        // 1. GPS 정보 먼저 셋팅.
////        37.541597, 126.838139
//        // Add a marker in Sydney and move the camera
//        LatLng sydney = new LatLng(37.541597, 126.838139);
////       37.540156, 126.839039
